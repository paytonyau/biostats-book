...
## A Note on Software Menu Language

PSPP's interface uses American English. The main menu reads **Analyze**, not *Analyse*. All lab instructions reproduce PSPP menu labels exactly as they appear in the software.
