...
Categorical vs continuous data · Nominal · Ordinal · Interval · Ratio · The Framingham variables classified · Lab: Loading the dataset in PSPP and R
...
Independent vs paired design · Levene's test · Welch's correction · Paired difference scores · Lab: Comparing blood pressure by smoking status; pre/post intervention example
...
Multiple comparisons problem · FWER · One-way ANOVA · F-statistic · Tukey's HSD · η² · Comparing proportions · RR and RD · Chi-Square · Fisher's Exact Test · Cramér's V · Lab: Cholesterol across education groups; smoking × CHD association

**Chapter 8 — Reading the Future**
*Correlation, Regression, and Survival Analysis*
Pearson's r · Spearman's rho · Correlation vs causation · Simple linear regression · β₀ and β₁ · R² · Regression assumptions · Kaplan-Meier curves · Log-rank test · Lab: Age predicts systolic BP; survival by smoking status
...
## Appendices
* **Appendix A** — Data Dictionary: Framingham Teaching Dataset
* **Appendix B** — Statistical Glossary (55 terms, A–Z)
